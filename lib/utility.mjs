...
if (!libvipsVersion.isGlobal) {
  if (!libvipsVersion.isWasm) {
    try {
      versions = require(`@img-loong64/sharp-${runtimePlatform}/versions`);
    } catch (_) {
      try {
        versions = require(`@img-loong64/sharp-libvips-${runtimePlatform}/versions`);
      } catch (_) {}
    }
  } else {
    try {
      versions = require('@img-loong64/sharp-wasm32/versions');
    } catch (_) {}
  }
}
