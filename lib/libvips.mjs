...
const prebuiltPlatforms = [
  ...
  'linux-arm', 'linux-arm64', 'linux-loong64', 'linux-ppc64', 'linux-riscv64', 'linux-s390x', 'linux-wasm32', 'linux-x64',
...
const buildSharpLibvipsIncludeDir = () => {
  try {
    return require(`@img-loong64/sharp-libvips-dev-${buildPlatformArch()}/include`);
  } catch {
    try {
      return require('@img-loong64/sharp-libvips-dev/include');
    } catch {}
  }
  return '';
};
...
const buildSharpLibvipsCPlusPlusDir = () => {
  try {
    return require('@img-loong64/sharp-libvips-dev/cplusplus');
  } catch {}
  return '';
};
...
const buildSharpLibvipsLibDir = () => {
  try {
    return require(`@img-loong64/sharp-libvips-dev-${buildPlatformArch()}/lib`);
  } catch {
    try {
      return require(`@img-loong64/sharp-libvips-${buildPlatformArch()}/lib`);
    } catch {}
  }
  return '';
};
...
const yarnLocator = () => {
  try {
    ...
    const npmVersion = semver.coerce(pkg.optionalDependencies[`@img-loong64/sharp-libvips-${buildPlatformArch()}`], {
